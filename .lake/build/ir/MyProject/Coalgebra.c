...
// Module: MyProject.Coalgebra
// Imports: Init Mathlib.RingTheory.TensorProduct
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_MyProject_Coalgebra(uint8_t builtin, lean_object* w) {
lean_object * res;
